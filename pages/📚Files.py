...
if st.session_state['connected']:
    ...
    uploaded_file = st.file_uploader(label="Učitaj datoteke, prezentacije, skripte, štogod!", type=None, accept_multiple_files=False, help="Učitavanjem datoteka ovdje EdBot dobiva novo znanje i može vam pomoći u razumijevanju skripte/gradiva koji vam nije jasan.")
    ...
    if st.button("Opameti me! 🧠", type='secondary', disabled=st.session_state.get("disabled", True)):
        ...
        st.success("EdBot je sada pametniji!🔥")
        st.session_state["files_changed"] = False
